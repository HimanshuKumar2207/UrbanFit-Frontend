...
import Title from "../components/Title"; // Importing the Title component to display section titles
    ...
    <div className="my-10">
      <div className="text-center py-8 text-3xl">
        ...
        <p className="w-3/4 m-auto text-xs sm:text-sm md:text-lg text-gray-600">
          Explore our latest collection featuring contemporary styles, premium
          fabrics, bold silhouettes, and versatile pieces crafted for every
          season and mood.
        </p>
      </div>
      {/* Rendering the latest products in a responsive grid layout */}
      <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-7 gap-y-6">
